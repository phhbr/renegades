export const privacy = {
  ...
  'privacy.cookie_settings.maps.description': 'Diese Cookies sind erforderlich, um Google Maps auf unserer Website anzuzeigen. Sie helfen uns dabei, Ihnen die Standorte unserer Trainingseinrichtungen zu zeigen.',
  'privacy.cookie_settings.analytics.title': 'Analyse-Cookies',
  'privacy.cookie_settings.analytics.description': 'Diese Cookies helfen uns zu verstehen, wie Besucher mit unserer Website interagieren. Die Daten werden anonymisiert und helfen uns, Ihre Erfahrung zu verbessern.'
};